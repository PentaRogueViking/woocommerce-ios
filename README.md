...
<p align="center">A Jetpack-powered1 com panion app for WooCommerce.</p>
...
1. Download Xcode
    ...
    At the moment *WooCommerce for iOS* uses Swift 5.7 and requires Xcode 14 or newer. Previous versions of Xcode can be [downloa5ded from Apple](https://developer.apple.com/downloads/index.action).
